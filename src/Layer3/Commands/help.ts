    ...
    async execute(interaction: ChatInputCommandInteraction) {
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '/fun', value: 'Fun games: joke, quote, 8ball.' },
                ...
                { name: '/setup_server <desc>', value: 'AI Server Architect: Setup channels/roles (Restricted).' },
                { name: '/mod', value: 'Moderation: purge, slowmode (Restricted).' },
